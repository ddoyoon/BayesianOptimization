...
flags.DEFINE_integer("version", 1, "Original: ResNet v1, Improved: ResNet v2")
flags.DEFINE_integer("depth", 20, "One of 20, 32, 44, 56, 110, 164, 1001 (Some values are version specific)")
flags.DEFINE_bool("test", False, "Test run with few epochs")
